...
\* \*\*Sentiment Analysis:\*\* Computes polarity scores (-1 to +1) for news headlines on the fly.

\* \*\*Lambda Architecture:\*\*

&nbsp;   \* \*\*Speed Layer:\*\* Real-time dashboarding via InfluxDB \& Grafana.

&nbsp;   \* \*\*Batch Layer:\*\* Historical archiving in Delta Lake format (MinIO/S3).
...
git clone https://github.com/wijdanelbakhouchi/Projet\_BigData.git
...
├── spark\_processor.py       # Spark Structured Streaming logic \& Dual-Write

├── verify\_batch.py          # Script to query MinIO/Delta Lake
